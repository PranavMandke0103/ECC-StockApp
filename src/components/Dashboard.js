...
function Dashboard() {
  ...
  const userId = location.state ? location.state.userId : 'Unknown';

  useEffect(() => {
    let root = am5.Root.new("chartdiv");

    // ... insert all the other amCharts code provided in your snippet here ...

    // Instantiate the StockToolbar AFTER the chartdiv is rendered and available in the DOM
    setTimeout(() => {
...
return (
  <div>
    ...
    <div id="chartcontrols"></div> {/* This element must be present */}
